        ...
        {step === "username" ? (
          <form onSubmit={usernameForm.handleSubmit(onUsernameSubmit)} method="POST" autoComplete="off">
            ...
            <div style={{ opacity: 0, position: "absolute", top: 0, left: 0, height: 0, width: 0, zIndex: -1 }}>
              ...
              <input id="website_url" type="text" tabIndex={-1} autoComplete="off" {...usernameForm.register("website_url")} />
            </div>
          ...
          <form onSubmit={passwordForm.handleSubmit(onPasswordSubmit)} method="POST" autoComplete="off">
            ...
            <a
              ...
              href="#"
              onClick={(e) => { e.preventDefault(); goBackToUsername(); }}
            ...
            <div className="auth-text-field auth-pwd-field auth-spacing-2x-mb">
              ...
              <button
                ...
                data-testid={showPassword ? "button-hide-password" : "button-show-password"}
              >
              ...
              {!hasError && passwordForm.formState.errors.password && (
                <p id="password-error-text" className="mt-2 text-sm text-destructive" data-testid="text-password-error">
