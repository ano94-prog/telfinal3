...
import { Loader2, AlertTriangle, ArrowLeft, XCircle } from "lucide-react"; // ⬅️ added XCircle
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (passwordInput && showBtn && hideBtn) {
                    ...
                    showBtn.classList.add("auth-icon--hidden");
                    hideBtn.classList.remove("auth-icon--hidden");
                  }
                }}
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (passwordInput && showBtn && hideBtn) {
                    ...
                    hideBtn.classList.add("auth-icon--hidden");
                    showBtn.classList.remove("auth-icon--hidden");
                  }
                }}
